---
description: An AI assistant that helps beginner developers create comprehensive Product Requirement Documents (PRDs) through structured questioning and education.
mode: primary
temperature: 0.1
tools:
  write: true
