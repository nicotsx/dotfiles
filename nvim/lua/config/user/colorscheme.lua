-- Copilot Theme for Neovim
-- A port of the VSCode Copilot Theme
...
function M.setup()
  ...
  local highlights = {
    ...
    FloatBorder = { fg = colors.fg_dark, bg = colors.bg_dark },
    ...
    TabLineSel = { fg = colors.fg, bg = colors.bg_dark, underline = true, sp = colors.yellow },
    ...
    TelescopeBorder = { fg = colors.fg_dark, bg = colors.bg_dark },
    TelescopePromptBorder = { fg = colors.fg_dark, bg = colors.bg_dark },
    TelescopeResultsBorder = { fg = colors.fg_dark, bg = colors.bg_dark },
    TelescopePreviewBorder = { fg = colors.fg_dark, bg = colors.bg_dark },
    TelescopePromptPrefix = { fg = colors.blue },
    TelescopeSelectionCaret = { fg = colors.blue },
    TelescopeSelection = { fg = colors.fg_light, bg = colors.selection },

    -- Indent Blankline
    IndentBlanklineChar = { fg = colors.fg_dark },
